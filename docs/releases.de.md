...
## KBART-Import
Für den KBART-Import wurde eine Option hinzugefügt. Es werden nun Titel, die in einer aktualisierten Liste nicht mehr enthalten sind, als "gelöscht" und nicht mehr als "archiviert" markiert.
