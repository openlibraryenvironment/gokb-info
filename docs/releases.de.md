...
## KBART-Import
Für den KBART-Import wurden neue Optionen hinzugefügt. Zum einen werden Pakettitel, die in einer aktualisierten Liste nicht mehr enthalten sind, als "gelöscht" und nicht mehr als "archiviert" markiert. Zum anderen erhalten Titel, deren Datum in der KBART-Spalte “published online” in der Zukunft liegt, den Status “erwartet” und werden entsprechend in der Pakettitel-Übersicht angezeigt.
